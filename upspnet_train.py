...
tra_image_dir = os.path.join('CUHK_train_source' + os.sep)
tra_label_dir = os.path.join('CUHK_train_gt' + os.sep)
...
ite_num4val = 0
save_frq = 200 # save the model every 200 iterations
Loss_list = []
...
for epoch in range(0, epoch_num):
    ...
    ##save loss figure every 200 epochs
    if epoch%5==0:
        ...
        plt.savefig("aug_loss/aug_loss_{}.jpg".format(str(epoch/200)))
        print("Successfully saved loss figure!")
